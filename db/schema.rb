...
ActiveRecord::Schema[8.1].define(version: 2025_12_31_013952) do
  ...
  create_table "account_standards", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.datetime "created_at", null: false
    t.bigint "standard_id", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_account_standards_on_account_id"
    t.index ["standard_id"], name: "index_account_standards_on_standard_id"
  end

  create_table "account_tools", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.datetime "created_at", null: false
    t.bigint "tool_id", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_account_tools_on_account_id"
    t.index ["tool_id"], name: "index_account_tools_on_tool_id"
  end
  ...
  create_table "tool_members", force: :cascade do |t|
    t.bigint "account_tool_id", null: false
    t.bigint "account_user_id", null: false
    t.datetime "created_at", null: false
    t.boolean "shared", default: false, null: false
    t.datetime "updated_at", null: false
    t.index ["account_tool_id"], name: "index_tool_members_on_account_tool_id"
    t.index ["account_user_id"], name: "index_tool_members_on_account_user_id"
  end

  create_table "tool_standards", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.index ["tool_id", "position"], name: "index_tool_standards_on_tool_id_and_position", unique: true
    t.index ["tool_id"], name: "index_tool_standards_on_tool_id"
  end

  create_table "tools", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.boolean "final_standard_outer_ring", default: false, null: false
    t.boolean "landing_page", default: false, null: false
    t.string "name"
    t.datetime "updated_at", null: false
  end

  create_table "user_account_standards", force: :cascade do |t|
    t.bigint "account_standard_id", null: false
    t.bigint "account_user_id", null: false
    t.datetime "created_at", null: false
    t.integer "score"
    t.datetime "updated_at", null: false
    t.index ["account_standard_id"], name: "index_user_account_standards_on_account_standard_id"
    t.index ["account_user_id"], name: "index_user_account_standards_on_account_user_id"
  end
  ...
  add_foreign_key "account_standards", "accounts"
  add_foreign_key "account_standards", "standards"
  add_foreign_key "account_tools", "accounts"
  add_foreign_key "account_tools", "tools"
  ...
  add_foreign_key "tool_standards", "tools"
  add_foreign_key "user_account_standards", "account_standards"
  add_foreign_key "user_account_standards", "account_users"
end
